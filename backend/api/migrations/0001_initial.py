    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(blank=True, related_name='videos', to='api.genre')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(db_index=True, max_length=80)),
                ('tag', models.CharField(db_index=True, max_length=120, null=True)),
                ('wtype', models.CharField(db_index=True, max_length=60, null=True)),
                ('abb', models.CharField(db_index=True, max_length=40, null=True)),
                ('ipa', models.CharField(default=None, max_length=80, null=True)),
                ('instance_count', models.IntegerField(default=0)),
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.language')),
                ('root', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='derived_words', to='api.word')),
            ],
        ),
        migrations.AddField(
            model_name='userword',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word_set', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.wordset')),
            ],
        ),
        migrations.CreateModel(
